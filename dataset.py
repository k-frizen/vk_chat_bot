...
def set_dates() -> tuple[str, str]:
    """Возвращает три даты:
    1) дату в datetime.date формате - для генерации расписания.
    2) дату-имитацию ввода пользователем желаемой даты вылета (через неделю относительно сегодняшнего дня)
    3) дату-имитацию выбора пользователем действительной даты вылета (на следующий день
